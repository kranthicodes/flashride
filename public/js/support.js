$(document).ready(function() {
  ...
  $("#send-query").on("click", function(e) {
    e.preventDefault();
    var data = {
      subject: title,
    ...
    $.post("/supportemail", data, function() {
      ...
      $("#support-form").append(
        $("<div/>")
          .text("Thankyou for letting us know. We'll get back to you soon")
          .addClass("alert alert-success errorLog")
      );
      // alert("Thankyou for letting us know. We'll get back to you soon");
      $("#close").click();
    });
  });
});
